...
Now we read in our data from the xls file. This one is for states in the US and contains 52, all in separate sheets (because it contains Puerto Rico as well).
```{r}
