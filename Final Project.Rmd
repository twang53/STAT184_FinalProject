...
- **maps:** this package basically is a display of maps that I need for when I try graphing a leaflet graph
...
NEED ONE MORE VISUAL (not point or density)
```{r}
mapStates = map("state", fill = TRUE, plot = FALSE)
leaflet(data = mapStates) %>%
  addTiles() %>%
  addPolygons(fillColor = topo.colors(12, alpha = NULL), stroke = FALSE)
```
